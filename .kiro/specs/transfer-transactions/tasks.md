...
- [ ] 1. Modelo de dados e infraestrutura
  - [ ] 1.1 Adicionar propriedades de transferência ao TransactionDTO
  ...
  - [ ] 1.2 Adicionar DestinationAccountId ao TransactionReq
    - Adicionar propriedade `DestinationAccountId` (int?) ao modelo `TransactionReq`
    - _Requirements: 7.1_

  - [ ] 1.3 Adicionar DestinationAccountId ao TransactionApiRes
    - Adicionar propriedade `DestinationAccountId` (int?) ao modelo `TransactionApiRes`
    - _Requirements: 7.3_

  - [ ] 1.4 Criar migration no UniqueServer para DestinationAccountId
...
- [ ] 2. Repositório local (TransactionRepo)
  - [ ] 2.1 Atualizar queries para incluir DestinationAccount
    - Adicionar `.Include(t => t.DestinationAccount)` nas queries relevantes (GetByIdAsync, GetByMonthYear)
    - _Requirements: 3.4, 6.4_

  - [ ] 2.2 Atualizar GetPreviousBalanceAsync para considerar transferências como destino
...
- [ ] 3. Camada de serviço (TransactionService)
  - [ ] 3.1 Implementar lógica de criação de transferência em AddAsync
  ...
  - [ ] 3.2 Implementar lógica de edição de transferência em UpdateAsync
  ...
  - [ ] 3.3 Implementar lógica de exclusão de transferência em DeleteAsync
    - Ao soft-delete de uma transferência: reverter impacto no saldo da `DestinationAccount` (subtrair `|Amount|`)
    - _Requirements: 3.3, 4.3_

  - [ ] 3.4 Atualizar cálculo de Totais para excluir transferências
...
- [ ] 4. Checkpoint - Verificar model, repo e service
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. ViewModel e UI (TransactionEditVM)
  - [ ] 5.1 Adicionar propriedades de transferência ao TransactionEditVM
  ...
  - [ ] 5.2 Implementar lógica de toggle de tipo Transfer no TransactionEditVM
  ...
  - [ ] 5.3 Implementar validação de transferência no TransactionEditVM
  ...
  - [ ] 5.4 Atualizar TransactionEditPage XAML para transferências
...
- [ ] 6. Exibição na MainPage e ChartPage
  - [ ] 6.1 Atualizar MainVM para exibição de transferências na lista
  ...
  - [ ] 6.2 Atualizar template da lista de transações na MainPage
  ...
  - [ ] 6.3 Atualizar ChartVM para excluir transferências
...
- [ ] 7. Sincronização com servidor
  - [ ] 7.1 Atualizar PushAsync para incluir DestinationAccountId
  ...
  - [ ] 7.2 Atualizar PullAsync para resolver DestinationAccountId
...
- [ ] 8. Checkpoint - Verificar funcionalidade completa
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 9. Testes de propriedade (FsCheck)
  - [ ]* 9.1 Configurar projeto de testes e generators para Transfer
  ...
  - [ ]* 9.2 Write property test: Transfer field invariants
  ...
  - [ ]* 9.3 Write property test: Dual balance impact on creation
  ...
  - [ ]* 9.4 Write property test: Transfer is zero-sum
  ...
  - [ ]* 9.5 Write property test: Balance correction on value edit
  ...
  - [ ]* 9.6 Write property test: Balance reversal on deletion
  ...
  - [ ]* 9.7 Write property test: Transfer neutrality in totals
  ...
  - [ ]* 9.8 Write property test: Transfer exclusion from chart series
  ...
  - [ ]* 9.9 Write property test: Per-account previous balance includes transfers
  ...
  - [ ]* 9.10 Write property test: General previous balance net-zero
...
- [ ] 10. Testes unitários
  - [ ]* 10.1 Write unit tests para TransactionService (criação, edição, exclusão)
  ...
  - [ ]* 10.2 Write unit tests para TransactionEditVM (UI logic)
  ...
  - [ ]* 10.3 Write unit tests para sincronização
  ...
  - [ ]* 10.4 Write unit tests para Totais e ChartVM
...
- [ ] 11. Final checkpoint - Todos os testes passam
  - Ensure all tests pass, ask the user if questions arise.
